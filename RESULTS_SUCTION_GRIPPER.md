...
The per-step `episode_diagnostics.csv` files (~60MB each) are stored on **tyrone** at:
```
...
*Date: 2026-04-25*  
*Machine: tyrone (NVIDIA RTX A6000)*  
*Runtime: ~8.5 hours per seed × 3 seeds = 25.5 GPU-hours*
