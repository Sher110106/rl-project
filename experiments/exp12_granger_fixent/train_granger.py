"""
train_granger.py — Exp12: Granger with Fixed Entropy (ent_coef=0.05)
Test whether fixed entropy prevents late-training entropy collapse.
"""
import argparse, os
...
def train(timesteps):
    ...
    callbacks = [
        ...
        CheckpointCallback(save_freq=100_000,
                           ...
                           name_prefix="sac_granger_fixent"),
    ]

    print(f"\n[exp12_granger_fixent] SAC for {timesteps:,} steps (ent_coef=0.05)\n")
