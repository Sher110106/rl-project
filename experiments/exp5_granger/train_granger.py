"""
train_granger.py — Exp5: Dense Gripper + Granger-Causal Reward
Usage:
    python train_granger.py
    python train_granger.py --timesteps 2000000
"""
import argparse, os
...
def train(timesteps):
    ...
    callbacks = [
        ...
        CheckpointCallback(save_freq=100_000,
                           ...
                           name_prefix="sac_granger"),
    ]

    print(f"\n[exp5_granger] SAC for {timesteps:,} steps\n")
