"""
train_granger.py — Exp8: Granger Extended (2M steps)
Same as exp5 but longer training to see if performance continues climbing.
"""
import argparse, os
...
def train(timesteps):
    ...
    callbacks = [
        ...
        CheckpointCallback(save_freq=100_000,
                           ...
                           name_prefix="sac_granger_2m"),
    ]

    print(f"\n[exp8_granger_2m] SAC for {timesteps:,} steps\n")
