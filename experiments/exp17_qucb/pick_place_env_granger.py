"""
Experiment 17: Q-UCB Potential-Based Reward Shaping + Granger(scale=0.8)
------------------------------------------------------------------------
Base environment is identical to exp14 (best Granger config).
The Q-UCB shaping is applied at the SAC training level (see train_qucb.py).
"""

# Re-export from exp14 config — same env, novelty is in training script
import csv
import os
import random
