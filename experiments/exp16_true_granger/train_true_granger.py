"""
train_true_granger.py — Exp16: True Neural-Network Granger-Causal Reward
"""
import argparse, os
...
def train(timesteps):
    ...
    callbacks = [
        ...
        CheckpointCallback(save_freq=100_000,
                           ...
                           name_prefix="sac_true_granger"),
    ]

    print(f"\n[exp16_true_granger] SAC for {timesteps:,} steps")
    print("  True NN Granger causality (causal model vs baseline model)\n")
