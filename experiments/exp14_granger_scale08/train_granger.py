"""
train_granger.py — Exp14: Granger with CAUSAL_SCALE=0.8 (doubled)
Test sensitivity to causal reward weight.
"""
import argparse, os
...
def train(timesteps):
    ...
    callbacks = [
        ...
        CheckpointCallback(save_freq=100_000,
                           ...
                           name_prefix="sac_granger_s08"),
    ]

    print(f"\n[exp14_granger_scale08] SAC for {timesteps:,} steps (CAUSAL_SCALE=0.8)\n")
